...
<script setup>
	...
	const nomenclatureDetailLabels = computed(
		() => store.getPublicationByNomenclatureDetailLabels,
	)
	const nomenclatureDetailSeries = computed(
		() => store.getPublicationByNomenclatureDetailSeries,
	)
	const {
