  ...
  <v-row no-gutters
    ><v-col cols="12" sm="12" md="12" lg="6" xl="6" xxl="6">
      <v-container :height="'100%'">
        <t-area-card :isLoading="isFirstAreaLoading" title="Опубликование всех НПА по годам">
          <template #chart>
            <t-column-chart
    ...
    <v-col cols="12" sm="12" md="12" lg="6" xl="6" xxl="6">
      <v-container :height="'100%'">
        ...
        >
          ...
          <template #next
            ><v-btn color="primary" :loading="isSecondAreaNextLoading" @click="secondAreaNextMonth">
    ...
    <v-col cols="12" sm="12" md="12" lg="4" xl="4" xxl="4">
      <v-container :height="'100%'">
        ...
        >
          ...
          <template #next
            ><v-btn color="primary" :loading="isThirdAreaNextLoading" @click="thirdAreaNextQuarter">
              <v-icon>mdi-arrow-right</v-icon>
            </v-btn>
          </template>
    ...
    <v-col cols="12" sm="12" md="12" lg="4" xl="4" xxl="4">
      <v-container :height="'100%'">
        <t-area-card
          ...
          :title="
            'Опубликование по номенклатуре за ' + fourthAreaYear.startDate.split('.')[2] + ' г.'
          "
        >
          <template #chart>
            <t-column-chart
          ...
          <template #next
            ><v-btn color="primary" :loading="isFourthAreaNextLoading" @click="fourthAreaNextYear">
              <v-icon>mdi-arrow-right</v-icon>
            </v-btn>
          </template>
    ...
    <v-col cols="12" sm="12" md="12" lg="6" xl="6" xxl="6">
      <v-container :height="'100%'">
        ...
        >
          ...
          <template #next
            ><v-btn color="primary" :loading="isFifthAreaNextLoading" @click="fifthAreaNextQuarter">
              <v-icon>mdi-arrow-right</v-icon>
            </v-btn>
          </template>
    ...
    <v-col cols="12" sm="12" md="12" lg="6" xl="6" xxl="6">
      <v-container :height="'100%'">
        ...
        >
          ...
          <template #next
            ><v-btn color="primary" :loading="isSixthAreaNextLoading" @click="sixthAreaNextQuarter">
              <v-icon>mdi-arrow-right</v-icon>
            </v-btn>
          </template>
