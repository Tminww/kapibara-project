<template>
  <apexchart :options="data.chartOptions" :series="data.series" :height="props.height"></apexchart>
</template>
...
// Эмитим событие при клике на столбец
...
<style scoped>
/* Добавляем курсор pointer для столбцов */
